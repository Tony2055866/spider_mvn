...
public class TestSavePost {
	public static void main(String[] args) {
		 ...
		 WpPosts post= new WpPosts();
			ItblogUtil.setCommonPost(post, 0);
				...
				new Thread(){
					public void run(){
						 WpPosts post1= new WpPosts();
							ItblogUtil.setCommonPost(post1, 0);
							...
							post1.setPostTitle("tttt");
								...
								pdao.save(post1);
								//第一步存储结束！
								post1.setGuid(ItblogInit.host + "/?p=" + post1.getId());
								...
								ItblogUtil.setCommonPost(post2, 0);
								...
								post2.setPostTitle("tttt");
									...
									pdao.save(post2);
									//第一步存储结束！
									post2.setGuid(ItblogInit.host + "/?p=" + post2.getId());
